...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('plans', function (Blueprint $table) {
            ...
            $table->unsignedInteger(\App\Domains\Constant\Plan\PlanConstant::RANK)->unique()->after(\App\Domains\Constant\Plan\PlanConstant::DESCRIPTION)->default(rand(10,10000));
        });
    }
