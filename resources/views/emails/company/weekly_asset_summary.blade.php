  ...
  <div>
    ...
    <div style="
      ...
      <div style="height: 250px">
        <img src="https://s3.amazonaws.com/rayda.co/images+for+email+template/email-snapshot.png" style="width: 570px" alt="" />
      </div>
        ...
        <div>
          ...
          <div style="display: flex; line-height: 5px; margin: 20px 0px;">
            ...
            <div style="
                ...
                ">
              <div
                style="border: 1px solid rgba(0, 76, 204, 1); border-radius: 8px;  padding: 20px; margin-right: 10px;">
                <span style="
                    font-family: IBM Plex Sans;
                    font-size: 12px;
                    font-weight: 500;
            ...
            <div style="
                ...
                ">
              <div
                style="border: 1px solid rgba(0, 76, 204, 1); border-radius: 8px;  padding: 20px; margin-left: 10px;">
                <span style="
                    font-family: IBM Plex Sans;
                    font-size: 12px;
                    font-weight: 500;
