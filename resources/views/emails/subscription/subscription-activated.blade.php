...
<div style="background: linear-gradient(to top, transparent, #C0C0C040); padding: 2px 30px;">
  ...
  <div style="
    ...
    <p
      ...
      Your Subscription has been <br> activated successfully 👍
    </p>
    ...
    <p
      ...
      Your Rayda account has been moved to the <b> {{ strtolower($plan?->name) }} plan.</b> This means you
      now have access to the following benefits:
    </p>
