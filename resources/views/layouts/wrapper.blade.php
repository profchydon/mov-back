...
<body style="background-color: #f9f9f9; padding-top: 40px; padding-bottom: 10px;">
  ...
  <div
    ...
    <div style="margin-bottom: 15px; width: auto; padding: 30px 30px 15px 30px; text-align: center;">
      <img src="https://s3.amazonaws.com/rayda.co/images+for+email+template/rayda.png"
        style="max-width: 60%; height: auto; display: block; margin: 0 auto;" alt="Rayda logo">
    </div>
