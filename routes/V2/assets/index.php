...
Route::get('companies/{company}/asset-maintenances/map', [AssetMaintenanceController::class, 'getMaintenanceMap'])->middleware(['token.decrypt', 'payload.decrypt', 'auth:sanctum', 'user-in-company']);
